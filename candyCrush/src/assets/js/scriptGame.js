...
var Game = function() {
	...
	this.init = function(size, base, ui) {
		...
		this.t=setTimeout($.proxy(this.checkLines, this), 1000);
                countTime();
	}
	...
	this.swipeGems = function(a, aID, b, bID) {
           // alert("switch: "+ aID+" "+ bID+" "+this.size +" "+this.itemByLine);
		//console.log("switch: "+ aID+" "+ bID+" "+this.size +" "+this.itemByLine);
	...
	this.scoreUpdate = function(score){
		...
		this.ui.find('.score').text(this.score);
               //alert(currentCountDown())
                ...
                if(this.score>=levelScore)//stop timer
                {        
...
//                    countTime();
                   ...
                   // currentCountDown = createCountDown(3000);
                   // alert(levelScore);
                   // countdown();
...
//           // var win=window.location.href='gameover.html';
//           
//           // $('#tryAgain').onclick(newWindow());
//          
//           
//        //    $('#game').text("Game Over");
//        }else {
...
function newWindow(){
    ...
    $ui = $('#ui');
    $next=$('#next');
    $tragain=$('#tryAgainForm');
    $next.hide();
    $tragain.hide();
    //console.log(value);
    newGame = new Game();
    newGame.init(currentSize, $game, $ui);
    levelScore=currentSize;
    //countTime();
